...
<script>
import DanXuanJiaoJi from "../data/english/DanXuanJiaoJi";
import DanXuanCiHui from "../data/english/DanXuanCiHui";
import YueDu from "../data/english/YueDuNew";
import YueDuTFNew from "../data/english/YueDuTFNew";
import WanXing from "../data/english/WanXingNew";
export default {
  name: "english",
  data() {
    return {
  ...
  methods: {
    getDanXuan() {
      const arr = [...DanXuanCiHui, DanXuanJiaoJi];
      this.dxlist = [];
      for (let i = 0; i < 10; i++) {
